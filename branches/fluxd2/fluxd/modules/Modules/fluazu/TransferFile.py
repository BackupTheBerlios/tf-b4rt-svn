...
class TransferFile(object):
        ...
        if os.path.isfile(self.file):
            try:
                ...
                if len(content) > 11:
                    ...
                    self.logger.error("Failed to parse transfer-file %s " % self.file)

            except:
                self.logger.error("Failed to read transfer-file %s " % self.file)
        return False
    ...
    def write(self):
        ...
        try:
            ...
            self.logger.error("Failed to write transfer-file %s " % self.file)
        return False
