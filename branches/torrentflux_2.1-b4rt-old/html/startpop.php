...
<tr><form name="theForm" target="_parent" action="index.php" method="POST">
    ...
    <td>
        ...
        <tr>
            ...
            <td align="left"><input type="Text" name="maxcons" maxlength="4" size="4" value="<?php echo $cfg["maxcons"]; ?>"></td>
        </tr>
        <tr>
...
<?php
        ...
        // Force Queuing if not an admin.
            if (IsAdmin())
                echo "<input type='Checkbox' name='queue'>Add to Queue";
            else
...
?>
        ...
        <tr>
            ...
            <td colspan="3"><SELECT width="45" size="6" ONCHANGE="savepath.value= this.options[this.selectedIndex].value;"><?php $arDirTree = dirTree2 ($cfg["path"].getOwner($torrent).'/', $cfg["maxdepth"]) ; ?></SELECT></td>
        </tr>
        </table>
        <?php } ?>
        <!-- Skip hashcheck -->
