 ...
 */
function imageOutputNotSupported() {
    ...
    imageOutputGIF(base64_decode($data), 1190);
}

/**
 * output invalid referer image
 */
function imageOutputInvalidReferer() {
    ...
    imageOutputGIF(base64_decode($data), 565);
}

/**
 * output no-op image
 */
function imageOutputNoOp() {
	...
	imageOutputGIF(base64_decode($data), 554);
}
 ...
 * @param $len
 */
function imageOutputGIF($data, $len) {
...
/**
 * output label-image created with a existing image-file
 *
 * @param $bgimage
 * @param $label
 * @param $font
 ...
 * @param $b
 */
function imageOutputLabelFromImage($bgimage, $label,
		$font = 1,
		$x = 0, $y = 0,
		$r = 0, $g = 0, $b = 0) {
