...
/* $Id: AliasFile.nzbperl.php 1517 2006-11-07 22:40:28Z b4rt $ */
...
// class AliasFile for nzbperl-client
class AliasFileNzbperl extends AliasFile
{
    //--------------------------------------------------------------------------
    // ctor
    function AliasFileNzbperl($inFile,$user="",$cfg) {
        // version
		$this->version = "0.6";
		// initialize
        $this->Initialize($cfg);
