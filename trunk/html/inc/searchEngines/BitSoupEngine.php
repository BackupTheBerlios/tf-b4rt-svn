...
class bitSoup
{
    ...
    function BuildOutput($bg, $searchURL = '')
    {
		global $cfg;
        $output = "<tr>\n";
        $output .= "    <td width=16 bgcolor=\"".$bg."\"><a href=\"index.php?url_upload=".$this->torrentFile."\"><img src=\"themes/".$this->cfg['theme']."/images/download_owner.gif\" width=\"16\" height=\"16\" title=\"".$this->torrentName." - ".$this->fileCount." ".$cfg['_FILE']."\" border=0></a></td>\n";
